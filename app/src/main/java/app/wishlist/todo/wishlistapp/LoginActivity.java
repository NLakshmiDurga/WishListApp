...
//        textView.setTextSize(20);
        ...
        TextView textView = (TextView) findViewById(R.id.list_tv);
            ...
            public void onClick(View v) {
                ...
                if(Patterns.EMAIL_ADDRESS.matcher(emailid).matches()) {
                    ...
                    if (emailid.isEmpty() || password.isEmpty()){
                        Toast.makeText(LoginActivity.this, "Please give valid inputs (emailid,password)", Toast.LENGTH_LONG).show();
                    }
                    else{
                    ...
                    Toast.makeText(LoginActivity.this, "Please enter correct email address", Toast.LENGTH_LONG).show();
                }
            }
        });
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (loginResponse.status.equals("True")) {
                            ...
                            Intent intent = new Intent(LoginActivity.this, UserTasks.class);
                            finish();
